...
| periodo | 202601 |
| historias | 61 (`HU-01` … `HU-61`) — **58 terminadas**, 3 pendientes. El desglose y qué PR cerró cada una están en `[S4]` |
