...
| periodo | 202601 |
| historias | 61 (`HU-01` … `HU-61`) — **60 terminadas**, 1 pendiente. El desglose y qué PR cerró cada una están en `[S4]` |
