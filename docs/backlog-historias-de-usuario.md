...
| periodo | 202601 |
| historias | 61 (`HU-01` … `HU-61`) — **51 terminadas**, 10 pendientes. El desglose y qué PR cerró cada una están en `[S4]` |
