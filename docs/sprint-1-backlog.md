...
7. **Este documento es el plan, no el seguimiento.** El estado de cada tarea —pendiente o finalizada— y su
   agrupación en Pull Requests viven en `./plan-de-pull-requests.md`, que no reordena ni modifica ninguna
   tarea de aquí. Las convenciones de ramas y commits están en `./convenciones-de-git.md` (`TT-01`).
